 ...
 * @author Stefan
 */
public class VratiPrenocisteZaOdredjenogStudenta extends ApstraktnaGenerickaOperacija{
    @Override
    ...
    protected Object izvrsi(OpstiDomenskiObjekat odo) throws Exception {
        ...
        prenociste.setUslovPretrage("StudentID="+prenociste.getStudent().getStudentID());
