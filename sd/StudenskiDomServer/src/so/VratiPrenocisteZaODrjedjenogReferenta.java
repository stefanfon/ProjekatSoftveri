 ...
 * @author Stefan
 */
public class VratiPrenocisteZaODrjedjenogReferenta extends ApstraktnaGenerickaOperacija{
    ...
    protected Object izvrsi(OpstiDomenskiObjekat odo) throws Exception {
        ...
        prenociste.setUslovPretrage("BrojRadneKnjizice="+prenociste.getReferent().getBrojRadneKnjizice());
